...
function PlanPageInner() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Print-only section — renders all phases for PDF/print */}
      <div className="print-all-phases" style={{ display: "none" }}>
        <div className="print-header" style={{ padding: "0 2rem 1rem" }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: "11px", color: "#0EB2CD", letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: "6px" }}>
            Flight Plan
          </div>
          <h1 style={{ fontSize: "1.8rem", margin: "0 0 4px", fontFamily: "var(--font-heading)", fontWeight: 400 }}>
            {plan.observe?.title?.split(":")[0] ? "Your 90-Day Transition Plan" : "Your 90-Day Transition Plan"}
          </h1>
          <p style={{ fontSize: "12px", color: "#666", margin: 0 }}>
            Generated by Launch Sequence · launchsequence.io
          </p>
        </div>
        ...
        {phaseKeys.map((key) => {
          const p = plan[key];
          return (
            <div key={key} className="print-phase" style={{ padding: "1.5rem 2rem" }}>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: "1.1rem", color: "#0EB2CD", marginBottom: "6px" }}>
                {phaseNumbers[key]}
              </div>
              <h2 style={{ fontSize: "1.4rem", marginBottom: "6px", fontFamily: "var(--font-heading)", fontWeight: 400 }}>
                {p.title}
              </h2>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginBottom: "16px" }}>
                {p.actions.map((action, i) => (
                  <div key={i} className="card" style={{ padding: "10px 12px" }}>
                    <div style={{ fontSize: "12px", fontWeight: 600, marginBottom: "3px" }}>{action.title}</div>
                    <div style={{ fontSize: "11px", color: "#444", lineHeight: "1.5" }}>{action.description}</div>
                  </div>
                ))}
              </div>
              <div className="card-warm" style={{ padding: "10px 12px" }}>
